...
function perspective(result, fovy, aspect, near, far
    ){
...
function rotate(result, rad, axis
    ){
        mat4.rotate(result, result, rad, axis);
}

function scale(result, v
    ){
        mat4.scale(result, result, v);
}
